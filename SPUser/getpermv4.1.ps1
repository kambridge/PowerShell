...
$sitepermissions | Export-Csv -NoTypeInformation -Path c:\perms.csv 
...
[io.file]::readalltext("c:\perms.csv").replace("@{Email=","").replace("@{DisplayName=","").replace("}",";")|Out-File c:\perms.csv -Encoding ascii -Force
